...
function showCityCountryInfo(_obj)
{
	...
	showInfoObj.style.top = (_obj.y/multiply[zoom] + imageCoords[1] + canvas.offsetTop)%img[zoom].height  -50 + "px";
	showInfoObj.style.left = (_obj.x/multiply[zoom] + imageCoords[0] + canvas.offsetLeft)%img[zoom].width -300 + "px";
